...
class ResultadoRenalAdapter(private val resultados: List<ResultadoRenal>) :
    RecyclerView.Adapter<ResultadoRenalAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_resultado_renal, parent, false)
