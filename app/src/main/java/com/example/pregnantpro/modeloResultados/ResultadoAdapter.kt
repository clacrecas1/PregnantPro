...
class ResultadoAdapter(private val resultados: List<ResultadoAnalisis>) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.ivIcono.setImageResource(android.R.drawable.ic_dialog_info) // Icono predeterminado de Android
